...
public class User {
    ...
    public LocalDateTime getLinkingCodeExpiry() {
        return linkingCodeExpiry;
    }
    public void setLinkingCodeExpiry(LocalDateTime linkingCodeExpiry) {
        this.linkingCodeExpiry = linkingCodeExpiry;
    }
